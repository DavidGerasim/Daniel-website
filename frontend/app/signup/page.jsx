...
const SignUp = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-gradient-to-br from-gray-900/90 via-gray-800/80 to-gray-700/70 backdrop-blur-xl rounded-2xl shadow-2xl shadow-black/50 border border-white/10 max-h-[85vh] flex flex-col">
        <div className="overflow-y-auto p-10 flex flex-col gap-8">
